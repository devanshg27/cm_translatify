...
dhar_en, dhar_hi = parse_jsonl(DATA_DIR+'mrinal_dhar.jsonl', 'DHAR')
phinc_en, phinc_hi = parse_jsonl(DATA_DIR+'phinc.jsonl', 'PHINC')

file_mapping = {
    'train.en_XX': iitb_en_train,
    'train.hi_IN': iitb_hi_train,
    'valid.en_XX': iitb_en_val,
    'valid.hi_IN': iitb_hi_val,
    'test.en_XX': iitb_en_test,
    'test.hi_IN': iitb_hi_test,
    'dhar.en_XX': dhar_en,
    'dhar.hi_IN': dhar_hi,
    'phinc.en_XX': phinc_en,
    'phinc.hi_IN': phinc_hi,
}
