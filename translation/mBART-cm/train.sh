...
python3 code4_trim_mbart.py --pre-train-dir "$SCRATCH_DIR/mbart.cc25/" --ft-dict "$SCRATCH_DIR/trimmed/dict.txt" --langs $MBART_LANGS --output "$SCRATCH_DIR/trimmed/model.pt"
...
fairseq-train ${SCRATCH_DIR}/postprocessed/hi-en --encoder-normalize-before --decoder-normalize-before \
 ...
 --warmup-updates 2500 --max-update 20000 --dropout 0.3 --attention-dropout 0.1  --weight-decay 0.0 \
 --max-tokens 512 --update-freq 2 --save-interval 2 --save-interval-updates 8000 --keep-interval-updates 10 \
